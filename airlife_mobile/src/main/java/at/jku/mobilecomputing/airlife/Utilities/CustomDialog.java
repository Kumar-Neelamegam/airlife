...
public class CustomDialog extends Dialog implements
    ...
    private SpinKitView dgprogressBar;
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        dgprogressBar=findViewById(R.id.dgprogressBar);
...
//       ((AnimatedVectorDrawable)d).start();
    ...
    public final CustomDialog setPositiveButtonVisible(int visible) {
        this.yes.setVisibility(visible);
        return this;
    }


    public final CustomDialog setImageLogoVisible(int visible) {
        this.icon.setVisibility(View.GONE);
        return this;
    }

    public final CustomDialog setprogressBarVisible(int visible) {
        this.dgprogressBar.setVisibility(View.GONE);
        return this;
    }
